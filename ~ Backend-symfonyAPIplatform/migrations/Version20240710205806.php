 ...
 */
final class Version20240710205806 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project CHANGE status status VARCHAR(50) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project CHANGE status status VARCHAR(50) DEFAULT \'planning\' NOT NULL');
    }
}
